...
def get_project(request,id):
    ...
    #error_message = definations.load_model_to_memory(c.project_title,c.project_category)
    context = {
        ...
        'testing_type':c.testing_type,
        'classes':range(int(c.classes)),
    }
    return render(request,f'ai/livetest_toolkit.html',context = context)
